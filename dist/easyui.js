...
var Link = function (_InputElement) {
  ...
  _createClass(Link, [{
    ...
    value: function onClick(clickHandler, button) {
      ...
      _get(Object.getPrototypeOf(Link.prototype), 'onClick', this).call(this, function () {
